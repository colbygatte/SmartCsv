...
abstract class AbstractCsv implements Iterator
{
     ...
     * @param array $columns
     *
     * @return \ColbyGatte\SmartCsv\AbstractCsv New CSV instance, in sip mode.
     * @throws \Exception
     */
    public function only(array $columns)
    {
        if (empty($this->columnNamesAsKey)) {
            throw new \Exception("Columns have not been set");
        }
    ...
    public function pluckFromRows($columns)
    {
        ...
        foreach ($this as $row) {
            ...
            foreach ($columns as $column) {
                ...
                $valuesForRow[$column] = $row->$column;
            }
